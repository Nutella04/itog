...
<div class="box-shadow-1 position-regis" style="width: 34vw;background-color: white; border-radius: 1vw">
  <h2 class="mbv-2 text-center mtv-4">Регистрация</h2>
  <div class="col-8 mx-auto mtv-4 text-center pb-4">
	<form action="HEAD_reg.php" method="POST" enctype="multipart/form-data">
	  <input class="mtv-3 form-control" type="" placeholder="Логин" name="login">
		<input class="mtv-3 form-control" type="" placeholder="Телефон" name="phone">
		<input class="mtv-3 form-control" type="password" placeholder="Пароль" name="password">
		<button class="btn btn-success form-control mtv-3 mbv-2">Зарегистрироваться</button>
		<a href="index.php" class="text-dark">Вернуться назад</a>
	</form>
  </div>
</div>
